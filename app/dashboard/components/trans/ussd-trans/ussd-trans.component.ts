...
//import messageTrans from '../ussd-trans/ussd-trans.json';
...
@Component({
  ...
  styleUrls: ['./ussd-trans.component.css'],
  animations: [
    trigger('openClose', [
      state('open', style({
        display: 'block',
...
export class UssdTransComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ["gtrid", "servicename", "service_type", "servicegroup", "trans_type", "originating_timestamp", "sourcechannel", "sendercode",
    "message", "submittimestamp", "partner_del_status","partner_del_timestamp",  "charge_status", "charged_price", "actions"];
