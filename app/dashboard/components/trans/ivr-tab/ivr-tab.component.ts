...
@Component({
  selector: 'app-ivr-tab',
  templateUrl: './ivr-tab.component.html',
  animations: [
    trigger('openClose', [
      state('open', style({
        display: 'block',
  ...
  styleUrls: ['./ivr-tab.component.css']
})
export class IvrTabComponent implements OnInit {
  Date = new Date();
  ...
  ngAfterViewInit() {
    $('#ivr_grid').on("click", ".serviceGroup", function () {
      window["serviceDetails"]($(this).attr("data-id"));
    });

    $('#ivr_grid').on("click", ".manageuserrights", function () {
  ...
  public GetUsersList() {
    ...
    if ($.fn.DataTable.isDataTable('#ivr_grid')) {
      $('#ivr_grid').dataTable().fnDestroy();
      $('#ivr_grid').empty();
    }
    ...
    try {
      var columns = [
        ...
        {
          "data": "sendercode", title: "DIAL CODE", "width": "150px", "render": function (data) {
            return encodeURI(String(data));
          }
        },
        {
          "data": "calling_party", title: "CALL TYPE", "width": "150px", "render": function (data) {
            return encodeURI(String(data));
          }
        },
        {
          "data": "call_duration", title: "CALL DURATION", "width": "150px", "render": function (data) {
            return encodeURI(String(data));
          }
        },
        {
        ...
        {
          "data": "requested_price", title: "REQUESTED AMOUNT", "width": "150px", "render": function (data) {
            return encodeURI(String(data));
          }
        },
      ...
      var tbl = $('#ivr_grid').DataTable({
        ...
        ajax: (dataTablesParameters: any, callback) => {
          ...
          this.spinner.show();
          this.ccapiService.postData('subscriberdata/GetCCAREIVRTransactions', requesrParams).subscribe((resp: any) => {
            this.spinner.hide();
