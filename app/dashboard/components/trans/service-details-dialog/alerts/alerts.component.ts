...
export class AlertsComponent implements OnInit {
  ...
  displayedColumns: string[] = ["gtrid", "trans_type", "originating_timestamp", "sendercode", "message", "deliver_status", "delivered_on", "partner_del_status", "partner_del_timestamp", "submittimestamp", "charge_status","charged_price"];
